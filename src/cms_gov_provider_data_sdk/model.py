...
class JsonOrCsvQueryOkContentApplicationJsonSchema(sob.Object):
    """
    Attributes:
        results:
        count:
        schema: Schema of all resources queries, keyed by ID.
        query:
    """
...
class JsonOrCsvQueryOkContentApplicationJsonSchemaResults(sob.Array):
...
class DatastoreQueryResourcesItem(sob.Object):
    """
    Attributes:
...
class DatastoreImportsPostRequestBodyContentApplicationJsonSchema(sob.Object):
    """
    Attributes:
        plan_id:
    """
...
class DatastoreImportsIdentifierDeleteResponse(sob.Object):
    """
    Attributes:
        message:
    """
...
class DatastoreImportsIdentifierGetResponse(sob.Object):
    """
    Attributes:
        num_of_rows:
        num_of_columns:
...
class HarvestRunsPostRequestBodyContentApplicationJsonSchema(sob.Object):
    """
    Attributes:
        plan_id:
    """
...
class MetastoreSchemasSchemaIdItemsIdentifierRevisionsPostRequestBodyContentApplicationJsonSchema(  # noqa: E501
    sob.Object
):
    """
    Attributes:
...
sob.get_writable_object_meta(  # type: ignore
    MetastoreSchemasSchemaIdItemsIdentifierRevisionsPostRequestBodyContentApplicationJsonSchema  # noqa: E501
).properties = sob.Properties([
    ('message', sob.StringProperty()),
    (
        'state',
...
_POINTERS_CLASSES: typing.Dict[str, typing.Type[sob.abc.Model]] = {
    ...
    MetastoreSchemasSchemaIdItemsIdentifierRevisionsPostRequestBodyContentApplicationJsonSchema,  # noqa
    "#/paths/~1search/get/parameters/3/schema": SearchGet3,
    "#/paths/~1search/get/parameters/4/schema": SearchGet4,
